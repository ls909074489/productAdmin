...
import com.yy.common.utils.CollectionsUtil;
				...
				if (CollectionsUtil.isNotEmpty(filters)) {
					...
					for (SearchFilter filter : filters) {
						...
						case IN:
							...
							break;
						case IIN:
							In in3 = builder.in(expression);
							String[] valuesI = ((String) value).split(",");
							for (String val : valuesI) {
								in3.value(Integer.valueOf(replaceSpace(val)));
							}
							predicates.add(in3);
							break;
						case NOTIN:							
