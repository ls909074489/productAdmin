...
import com.yy.modules.sys.log.LogLoginEntity;
...
public class MyFormAuthenticationFilter extends FormAuthenticationFilter {
	...
	protected boolean onAccessDenied(ServletRequest request, ServletResponse response, Object mappedValue)
		...
		// 取出页面的验证码
		String vCode = httpServletRequest.getParameter("validatecode");
		...
		// 验证码是否页面的验证码，验证码是否为空
		if (vCode != null && validateCode != null && !vCode.equals(validateCode)) {
			httpServletRequest.setAttribute("shiroLoginFailure", "ValidateCodeError");
			return true;
		}
