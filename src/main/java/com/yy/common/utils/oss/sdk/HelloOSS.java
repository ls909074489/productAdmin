package com.yy.common.utils.oss.sdk;
...
public class HelloOSS {
    ...
    private static String endpoint = "http://oss-cn-shenzhen.aliyuncs.com";//http://oss-cn-hangzhou-internal.aliyuncs.com";//"http://oss-cn-hangzhou.aliyuncs.com";

    // accessKeyId和accessKeySecret是OSS的访问密钥，您可以在控制台上创建和查看，
    // 创建和查看访问密钥的链接地址是：https://ak-console.aliyun.com/#/。
    // 注意：accessKeyId和accessKeySecret前后都没有空格，从控制台复制时请检查并去除多余的空格。
    private static String accessKeyId = "5uLVJDKTjUez1VsD";//"xmYt1ZCeJyA8yWkL";
    private static String accessKeySecret = "AZ20Sv025NRHuW3tWcWQRKfM3DJKcT";//"z4UzrXOIqvDSiagXJeMcwefxtaq6fy";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "lsbucket";//"bucket-csc";
    ...
    public static void main(String[] args) {
        ...
        // 日志的配置文件是“conf/log4j.properties”，如果您不需要日志，可以没有日志配置文件和下面的日志配置。
    	 PropertyConfigurator.configure(Thread.currentThread().getContextClassLoader().getResource("").getPath()+"conf/log4j.properties");//PropertyConfigurator.configure("conf/log4j.properties");
