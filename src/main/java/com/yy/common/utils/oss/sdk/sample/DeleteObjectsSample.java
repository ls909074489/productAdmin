...
//    private static String bucketName = "*** Provide bucket name ***";
	...
	public static String accessKeyId = "xmYt1ZCeJyA8yWkL";
	public static String accessKeySecret = "z4UzrXOIqvDSiagXJeMcwefxtaq6fy";
	public static String bucketName = "bucket-csc";//"csc-bucket-csc";
