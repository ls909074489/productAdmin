	...
	function onRefreshSelect() {
	 ...
	 //显示自定义的行按钮
	  ...
	  //显示自定义的行按钮
		...
		function loadList(){
			$.ajax({
				url : '${serviceurl}/findAllUserByItemId?itemId=${itemId}',
		...
		function loadListSelect(){
			$.ajax({
				url : '${serviceurl}/findUserByItemId?itemId=${itemId}',
		...
		function selObj(aData, iDataIndex, nRow){
			...
			var itemId='${itemId}';
			$.ajax({
				 url: '${ctx}/process/itemuser/selecItemUser',
			       type: 'post',
			       data : {
						'itemId' : itemId,
						'userId':userId
		...
		function delObj(aData, iDataIndex, nRow){
			...
			var itemId='${itemId}';
			$.ajax({
				url: '${ctx}/process/itemuser/delItemUser',
			       type: 'post',
			       data : {
						'itemId' : itemId,
						'userId':userId
