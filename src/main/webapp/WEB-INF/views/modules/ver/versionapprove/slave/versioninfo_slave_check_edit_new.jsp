		...
		function bindButtonAction(){
			$('#yy-btn-approve-x').on('click', function() {
				layer.open({
				    ...
				    shadeClose : false,
					shade : 0.8,
				    content: '${ctx}/ver/versioninfo/toRemarkVersion?callBackMethod=window.parent.callBackApprovce&formAction=${serviceurl}/approveNew&uuid=${entity.uuid}&operStr=审核'
				});
			...
			$('#yy-btn-unapprove').on('click', function() {
				layer.open({
				    ...
				    shadeClose : false,
					shade : 0.8,
				    content: '${ctx}/ver/versioninfo/toRemarkVersion?callBackMethod=window.parent.callBackUnApprovce&formAction=${serviceurl}/unApproveNew&uuid=${entity.uuid}&operStr=退回'
				});
