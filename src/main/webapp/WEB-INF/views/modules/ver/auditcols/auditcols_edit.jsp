...
<body>
					...
					<div class="row">
							<div class="col-md-8">
								<div class="form-group">
									...
									<div class="col-md-10"><input class="form-control"  id="name" name="name"  type="text" value="${entity.name}" readonly="readonly"></div>
								</div>
							</div>	
					</div>
			</form>
	...
	var _subTableCols = [{
		...
		render : function(data, type, full) {
			...
			return '<input class="form-control" value="'+ data + '" name="rownum">';
		}
	}, {
		data : "columnName",
		orderable : false,
		...
		render : function(data, type, full) {
			...
			return '<input type="hidden" name="uuid" value="'+tUuid+'"><input class="form-control" value="'+ data + '" name="columnName">';
		}
	}, {
		data : "columnAnno",
		orderable : false,
		...
		render : function(data, type, full) {
			if(data==null){
				return '<input class="form-control" value="" name="columnAnno">';
			}else{
				return '<input class="form-control" value="'+ data + '" name="columnAnno">';
			}
		}
	}, {
		data : "width",
		...
		render : function(data, type, full) {
			...
			return '<input class="form-control" value="'+ data + '" name="width">';
		}
	}, {
		data : 'isDisplay',
		width : "60",
		...
		render : function(data, type, full) {
	        ...
	        return YYDataUtils.getEnumSelect("BooleanType",data,"isDisplay");
	    }
	}, {
		data : 'isCompare',
		width : "60",
		...
		orderable : false,
		render : function(data, type, full) {
			 return YYDataUtils.getEnumSelect("BooleanType",data,"isCompare");
	    }
	},{
		data : 'compareType',
		width : "60",
		...
		orderable : false,
		render : function(data, type, full) {
			 return YYDataUtils.getEnumSelect("AuditCompareType",data,"compareType");
	    }
	}];
