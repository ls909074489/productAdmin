...
<body>
	...
	<div style="width: 780px;">
		<form id="yy-form-edit" class="form-horizontal yy-form-edit">
			...
			<table style="margin-left: 20px;" class="yy-table">
				...
				<tr>
					<td>
						<select name="ykPass2" class="yy-input-enumdata form-control" data-enum-group="BooleanType"></select>
					</td>
					<td>
					...
					<td>
						<select name="yxPass2" class="yy-input-enumdata form-control" data-enum-group="BooleanType"></select>
					</td>
					<td>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			bindEditActions();
			validateForms();
			$("select[name='ykPass2']").val('${entity.ykPass2}');
			$("select[name='yxPass2']").val('${entity.yxPass2}');
		});
