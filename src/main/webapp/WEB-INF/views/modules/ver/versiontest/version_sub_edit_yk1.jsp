...
<body>
	...
	<div style="width: 780px;">
		<form id="yy-form-edit" class="form-horizontal yy-form-edit">
			...
			<table style="margin-left: 20px;" class="yy-table">
				<tr>
					<th style="width: 120px;text-align:center;">遥控执行是否正常</th>
					<th style="width: 100px;text-align:center;">测试时间</th>
					<th style="width: 120px;text-align:center;">遥信返回是否正常</th>
					<th style="width: 100px;text-align:center;">测试时间</th>
				...
				<tr>
					<td>
						<select name="ykPass1" class="yy-input-enumdata form-control" data-enum-group="BooleanType"></select>
					</td>
					<td>
					...
					<td>
						<select name="yxPass1" class="yy-input-enumdata form-control" data-enum-group="BooleanType"></select>
					</td>
					<td>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			bindEditActions();
			validateForms();
			$("select[name='ykPass1']").val('${entity.ykPass1}');
			$("select[name='yxPass1']").val('${entity.yxPass1}');
		});
