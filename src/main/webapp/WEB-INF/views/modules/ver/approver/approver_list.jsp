...
<c:set var="serviceurl" value="${ctx}/ver/approverflow"/>
<html>
<head>
<title>审核流程表</title>
</head>
<body>
		...
		<div class="page-content" id="yy-page-list">
			...
			<div class="row yy-searchbar form-inline">
				<form id="yy-form-query">
					...
					<label for="search_LIKE_name" class="control-label">主版本号</label>
	...
	<script type="text/javascript">
		...
		var _tableCols = [ {
							...
							className : "center",
							orderable : false,
							render : YYDataTableUtils.renderViewEditActionCol,//renderActionCol
							width : "50"
						},{
							data : "name",
							width : "20%",
