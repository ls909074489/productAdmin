...
<body>
	...
	<script type="text/javascript">
		...
		var _tableCols = [ {
			...
			className : "center",
			orderable : false,
			render : YYDataTableUtils.renderViewActionCol,//YYDataTableUtils.renderActionCol,
			width : "30"
		}, {
			data : 'billstatus',
			width : "60",
		...
		function onAdd() {
			...
			layer.open({
				...
				closeBtn : 0,//关闭按钮
				area : [ '100%', '100%' ],
				content : '${serviceurl}/onAddSlave?'+ _addParam, //iframe的url
			});
			onAddAfter();
		}
		...
		function onEditRow(aData, iDataIndex, nRow) {
			...
			layer.open({
				...
				closeBtn : 0,//关闭按钮
				area : [ '100%', '100%' ],
				content : '${serviceurl}/onEditSlave?uuid=' + aData.uuid + '&' + _editParam, //iframe的url
			});
		...
		function onViewDetailRow(data, rowidx, row) {
			layer.open({
				...
				closeBtn : 0,//关闭按钮
				area : [ '100%', '100%' ],
				content : '${serviceurl}/onDetailSlave?uuid=' + data.uuid + '&' + _detailParam, //iframe的url
			});
		}
