...
<body>
	<div id="yy-page-edit" class="container-fluid page-container page-content" >
		<div class="row yy-toolbar">
			...
			<button id="yy-btn-extract" class="btn yellow btn-sm btn-info">
				<i class="fa fa-send"></i> 获取主站信息
			</button>
	...
	var jsonResp = jQuery.parseJSON('${colsJson}');
		...
		$(document).ready(function() {
			...
			$("#yy-btn-extract").bind('click', onExtractMaster);//获取主站信息
		...
		//获取主站信息
		function onExtractMaster(){
			var extraInfoLoading = layer.load(2);
			$.ajax({
				type : "POST",
				data :{"uuid": '${entity.uuid}'},
				url : "${serviceurl}/extractMaster",
				async : true,
				dataType : "json",
				success : function(data) {
					layer.close(extraInfoLoading);
					if (data.success) {
						YYUI.succMsg(YYMsg.alertMsg('sys-success-todo',['获取主站信息']));
					}else {
						YYUI.promAlert(YYMsg.alertMsg('sys-fail-todo',['获取主站信息'])+data.msg);
					}
