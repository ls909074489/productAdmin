	...
	<div class="page-content" id="yy-page-list">
		...
		<script type="text/javascript">
			...
			function confirmImport(){
				...
				var posturl = "${serviceurl}/uploadExplainFile";

				var file = $("#multifile")[0].files[0];
					var formData = new FormData();
					formData.append("attachment", file,file.name);
					formData.append("mainindex", "${mainindex}");
					formData.append("isMasterNew", "${isMasterNew}");
			...
			function onQueryFile(){
				...
				var jsonUpLoadFileTypeResp = jQuery.parseJSON('${upLoadFileTypeJson}');
				var isAccFile=false;
				var accFile="";
				if(jsonUpLoadFileTypeResp){
					for(var i=0;i<jsonUpLoadFileTypeResp.length;i++){
						accFile+=(jsonUpLoadFileTypeResp[i].enumdatakey+" ");
						if(jsonUpLoadFileTypeResp[i].enumdatakey==prefix){
							isAccFile=true;
						}
					}
				}
				if(isAccFile){//prefix == "ini"||prefix == "xls"||prefix == "dat"
