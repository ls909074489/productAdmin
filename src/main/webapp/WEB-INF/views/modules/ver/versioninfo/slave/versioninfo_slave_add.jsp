...
<body>
	...
	<div>
		<form id="yy-form-edit" class="form-horizontal yy-form-edit">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="col-md-8">
							<div class="input-group input-icon right">
									<input id="approverUserUuid" name="approverUserGroup.uuid" type="hidden" value="${userGroup.uuid}"> 
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label col-md-4 required">打开</label>
						<div class="col-md-8">
							<div class="input-group input-icon right">
									<i class="fa fa-remove" title="清空"></i>
									<input id="pkgPathNameOpen" name="pkgPathNameOpen" type="text" class="form-control" readonly="readonly" 
										value="">
									<span class="input-group-btn">
										<button id="pkgPath-open-btn" class="btn btn-default btn-ref" type="button">
											<span class="glyphicon glyphicon-search"></span>
										</button>
									</span>
							</div>
	...
	var jsonResp = jQuery.parseJSON('${colsJson}');
		...
		function bindButtonAction(){
			...
			//打开
			$('#pkgPath-open-btn ').on('click', function() {
				layer.open({
					type : 2,
					title : '请选择版本',
					shadeClose : false,
					shade : 0.8,
					area : [ '500px', '160px' ],
					content : '${serviceurl}/toUploadVersion?callBackMethod=window.parent.callBackUploadFile&mainindex='+$("#mainindex").val()
				});
			});
