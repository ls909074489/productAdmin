...
<body>
		...
		<div class="page-content" id="yy-page-list">
			...
			<div class="row yy-searchbar form-inline">
				<form id="yy-form-query">
					<label for="search_EQ_channelType" class="control-label">通道类型</label>
					<select class="yy-input-enumdata form-control" id="search_EQ_channelType" 
						name="search_EQ_channelType" data-enum-group="ChannelType"></select>
	...
	<script type="text/javascript">
		...
		var _tableCols = [ {
							...
							orderable : true,
							render : function(data, type, full) {
							       return YYDataUtils.getEnumName("ChannelType", data)+"";
							}
						},{
							data : "argument",
							width : "20%",
