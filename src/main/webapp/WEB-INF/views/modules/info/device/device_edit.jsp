...
<body>
	...
	<div>
		<form id="yy-form-edit" class="form-horizontal yy-form-edit" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label col-md-4 required">间隔</label>
						<div class="col-md-8">
							<div class="input-group input-icon right">
									<input id="intervalUuid" name="interval.uuid" type="hidden" value="${entity.interval.uuid}"> 
									<i class="fa fa-remove" onclick="cleanDef('intervalUuid','intervalName');" title="清空"></i>
									<input id="intervalName" name="intervalName" type="text" class="form-control" readonly="readonly" 
										value="${entity.interval.name}">
									<span class="input-group-btn">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label col-md-4 required">生产厂商</label>
						<div class="col-md-8">
							<div class="input-group input-icon right">
	...
	<script type="text/javascript">
		...
		//回调选择
		function callBackSelSupplier(data){
		...
		function callBackInterval(data){
			$("#intervalUuid").val(data.uuid);
			$("#intervalName").val(data.name);
		}
